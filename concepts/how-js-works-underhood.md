...
### **How JavaScript Code Gets Executed** <a href="#heading-how-javascript-code-gets-executed" id="heading-how-javascript-code-gets-executed"></a>
...
#### **Global Execution Context (GEC)** <a href="#heading-global-execution-context-gec" id="heading-global-execution-context-gec"></a>
...
#### **Function Execution Context (FEC)** <a href="#heading-function-execution-context-fec" id="heading-function-execution-context-fec"></a>

Whenever a function is called, the JavaScript engine creates a different type of Execution Context known as a Function Execution Context (FEC) within the GEC to evaluate and execute the code within that function.

Since every function call gets its own FEC, there can be more than one FEC in the run-time of a script.

### **How are Execution Contexts Created?** <a href="#heading-how-are-execution-contexts-created" id="heading-how-are-execution-contexts-created"></a>
...
#### Creation Phase <a href="#heading-creation-phase" id="heading-creation-phase"></a>
...
#### **Creation Phase: Creation Of The Variable Object (VO)** <a href="#heading-creation-phase-creation-of-the-variable-object-vo" id="heading-creation-phase-creation-of-the-variable-object-vo"></a>
...
#### **Hoisting in JavaScript** <a href="#heading-hoisting-in-javascript" id="heading-hoisting-in-javascript"></a>
...
#### **Creation Phase: Creation of The Scope Chain** <a href="#heading-creation-phase-creation-of-the-scope-chain" id="heading-creation-phase-creation-of-the-scope-chain"></a>
...
#### Creation Phase: Setting The Value of The "this" Keyword <a href="#heading-creation-phase-setting-the-value-of-the-this-keyword" id="heading-creation-phase-setting-the-value-of-the-this-keyword"></a>
...
#### **The Execution Phase** <a href="#heading-the-execution-phase" id="heading-the-execution-phase"></a>
...
### **JavaScript Execution Stack** <a href="#heading-javascript-execution-stack" id="heading-javascript-execution-stack"></a>
...
### **Global Execution Context VS. Function Execution Context in JavaScript** <a href="#heading-global-execution-context-vs-function-execution-context-in-javascript" id="heading-global-execution-context-vs-function-execution-context-in-javascript"></a>
